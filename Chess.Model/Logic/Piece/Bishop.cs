...
{
  /// <summary>
  /// Represents the Bishop FlyweightPiece contained in FlyweightPieceFactory.
  /// Used for move generation.
  /// </summary>
  class Bishop : IFlyweightPiece
  {
    /// <summary>
    ...
    /// </summary>
    private Direction[] m_directions = { Direction.DownLeft, Direction.DownRight, Direction.UpLeft, Direction.UpRight };
    ...
    {
      if (Math.Abs(Board.File(from) - Board.File(to)) == Math.Abs(Board.Rank(from) - Board.Rank(to)))
      {
