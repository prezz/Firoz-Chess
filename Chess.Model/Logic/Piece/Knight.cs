...
namespace Chess.Model.Logic
{
  ...
  class Knight : IFlyweightPiece
  {
    ...
    /// </summary>
    private Direction[] m_directions = { Direction.Right, Direction.Up, Direction.Up, Direction.Left, Direction.Left,
											                   Direction.Down, Direction.Down, Direction.Right, Direction.Right, Direction.Up };

    /// <summary>
    /// The amount of moves a knight at max can make.
    /// </summary>
    private const int KNIGHT_MOVES = 8;
